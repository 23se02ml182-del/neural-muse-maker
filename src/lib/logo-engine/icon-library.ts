...
const ICONS: Record<string, IconSpec[]> = {
  ...
  // ─── Technology (Neon Cyber Nodes & AI) ───
  technology: [
    // Connected Nodes Globe
    { viewBox: "0 0 24 24", paths: ["M12 2a10 10 0 0 0-10 10 10 10 0 0 0 10 10 10 10 0 0 0 10-10A10 10 0 0 0 12 2zm0 18a8 8 0 1 1 0-16 8 8 0 0 1 0 16z", "M12 6a6 6 0 1 0 0 12 6 6 0 0 0 0-12zm0 10a4 4 0 1 1 0-8 4 4 0 0 1 0 8z", "M12 2v4M12 18v4M2 12h4M18 12h4", "M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83", "M12 12m-1.5 0a1.5 1.5 0 1 0 3 0 1.5 1.5 0 1 0-3 0"] },
    // Cyber Brain Circuit
    { viewBox: "0 0 24 24", paths: ["M12 3a7 7 0 0 0-7 7c0 1.5.5 2.8 1.3 4H5v2h2v3h10v-3h2v-2h-1.3c.8-1.2 1.3-2.5 1.3-4a7 7 0 0 0-7-7z", "M12 3v18", "M12 8h-3", "M12 12h-4", "M12 16h-2", "M12 8h3", "M12 12h4", "M12 16h2", "M9 8a1 1 0 1 0-2 0 1 1 0 0 0 2 0z", "M8 12a1 1 0 1 0-2 0 1 1 0 0 0 2 0z", "M10 16a1 1 0 1 0-2 0 1 1 0 0 0 2 0z", "M15 8a1 1 0 1 0 2 0 1 1 0 0 0-2 0z", "M16 12a1 1 0 1 0 2 0 1 1 0 0 0-2 0z", "M14 16a1 1 0 1 0 2 0 1 1 0 0 0-2 0z"] },
    // AI Tech Lightbulb Node
    { viewBox: "0 0 24 24", paths: ["M12 2c-4.4 0-8 3.6-8 8 0 3.3 2 6.2 5 7.5V19a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-1.5c3-1.3 5-4.2 5-7.5 0-4.4-3.6-8-8-8z", "M9 22h6", "M12 2v5", "M7.5 6.5l3.5 3.5", "M16.5 6.5l-3.5 3.5", "M5 12h5", "M19 12h-5", "M12 10a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"] },
    // Geometric Synapse Ring
    { viewBox: "0 0 24 24", paths: ["M12 2L3.5 7v10L12 22l8.5-5V7L12 2z", "M12 6.5l-4.5 2.5v5l4.5 2.5 4.5-2.5v-5L12 6.5z", "M12 12m-1.5 0a1.5 1.5 0 1 0 3 0 1.5 1.5 0 1 0-3 0", "M12 6.5V2", "M12 17.5V22", "M7.5 9l-4-2.5", "M7.5 15l-4 2.5", "M16.5 9l4-2.5", "M16.5 15l4 2.5"] },
    // Circuit Board Shield
    { viewBox: "0 0 24 24", paths: ["M12 2L4 5v6c0 5.5 3.8 10.7 8 12 4.2-1.3 8-6.5 8-12V5l-8-3z", "M12 6a3 3 0 1 0 0 6 3 3 0 0 0 0-6z", "M12 12v6", "M9.8 10l-3.8-3.8", "M14.2 10l3.8-3.8", "M10 18H7", "M14 18h3", "M7 18a1 1 0 1 0-2 0 1 1 0 0 0 2 0z", "M17 18a1 1 0 1 0 2 0 1 1 0 0 0-2 0z", "M6 6.2a1 1 0 1 0-2 0 1 1 0 0 0 2 0z", "M18 6.2a1 1 0 1 0 2 0 1 1 0 0 0-2 0z"] },
  ],
